...
//c. Código de los dos productos más económicos.
procedure productosEconomicos(l:lista; var precioCod1,precioCod2,cod1,cod2:integer);
var temp:lista;
begin
    temp:=l;
    while(temp<>nil)do begin
        if(temp^.elem.precio<precioCod1) then begin
            precioCod2:=precioCod1;
            cod2:=cod1;
            precioCod1:=temp^.elem.precio;
            cod1:=temp^.elem.codigo;
        end
        else if(temp^.elem.precio<precioCod2)then begin
            precioCod2:=temp^.elem.precio;
            cod2:=temp^.elem.codigo;
        end;
        temp:=temp^.sig;
    end;
end;
...
var
    l:lista;
    precioEco1,precioEco2:integer;
    codiEco1,codiEco2:integer;
begin
    precioEco1:=9999;
    precioEco2:=9999;
    codiEco1:=9999;
    ...
    digPares(l);
    porcentaje(l);
    productosEconomicos(l,precioEco1,precioEco2,codiEco1,codiEco2);
    WriteLn('El codigo mas economico es: ', codiEco1);
    WriteLn('El segundo codigo mas economico es: ', codiEco2);
end.